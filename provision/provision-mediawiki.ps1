...
$builtInDownloadChecksums = @{
    ...
    'mediawiki-extensions-VisualEditor-REL1_43.zip' = '8D60A9DC0EEDC833469C3B683922D8FE739DE98B0E9824FEF6925041EE26A987'
...
$Script:ZipExtensions = @(
    ...
    'Linter', 'Scribunto', 'UploadWizard',
    'Popups', 'PageImages', 'TextExtracts', 'MultimediaViewer',
    'SyntaxHighlight_GeSHi', 'Math', 'PdfHandler', 'PageForms'
)
if (-not $InstallPdfTools) { $Script:ZipExtensions = @($Script:ZipExtensions | Where-Object { $_ -ne 'PdfHandler' }) }
